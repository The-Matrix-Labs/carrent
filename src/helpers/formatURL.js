...
export function getRedirectURL(listId, urlParameters) {
    ...
    if (urlParameters && urlParameters.listTitle && urlParameters.startDate && urlParameters.endDate) {
        ...
        let refer = "/cars/" + formatURL(urlParameters.listTitle) + '-' + listId + "?&startdate=" + startDate + "&enddate=" + endDate + "&startTime=" + urlParameters.startTime + "&endTime=" + urlParameters.endTime + "&roomType=" + urlParameters.deliveryStatus;
