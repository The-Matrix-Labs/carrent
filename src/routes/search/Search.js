...
class Search extends React.Component {
  ...
  mobileNavigation() {
    ...
    if (searchResults) {
      leftNav = <Button className={cx(s.filterButton, s.locationBtn, 'locationBtnRTL')} bsStyle="link" onClick={() => showMap()}><Material.MdRoom className={s.icon} /></Button>;
    ...
    return (
      <div className={cx(s.root, 'searchPage')}>
        <div className={s.container}>
          ...
          {
            !smallDevice && isMapShow && <div className={cx(s.searchMapContainer, 'searchMapSection', 'searchMapContainerRTL')}>
