  ...
  render() {
    ...
    return (
      <div className={cx(s.recommendations, s.spaceTop4)}>
        <div className={s.heading}>{reviewsCount > 1 ? formatMessage(messages.reviews) : formatMessage(messages.review)} <small className='displayInlineRTL'>({reviewsCount})</small></div>
        {
