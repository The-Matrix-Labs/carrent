...
class MenuComponent extends React.Component {
  render() {
    ...
    return(
       <div className={cx(s.progressContainer, "hidden-xs", "hidden-print", 'SubnavBarRTL')}>
        <ul className={cx(s.navList)}>
          ...
          <li className={cx({ [s.active]: location === "/cars" || location === "/reservation/current" 
            || location === "/reservation/previous"})}>
            <Link to={"/cars"} className={s.navItem}>
