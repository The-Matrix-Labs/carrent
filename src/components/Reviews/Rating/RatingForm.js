  ...
  renderFormControlTextArea = ({ input, label, meta: { touched, error }, children, className }) => {
    ...
    return (
      <div className={'inputFocusColor'}>
        <FormGroup className={cx(s.space4, s.formGroup)}>
          <FormControl
            {...input}
            className={className}
  ...
  render() {
    ...
    return (
      <Row className={s.landingContainer}>
        <Col xs={12} sm={6} md={6} lg={6} className={cx(s.landingContent, s.spaceTop5)}>
          ...
          <Form onSubmit={handleSubmit(this.submitForm)}>
            <div>
              ...
              />
              <strong className={s.rateingText}><span><FormattedMessage {...messages.reviewRating} /></span></strong>
              <Field
                name="rating"
        ...
        <Col lg={6} md={6} sm={6} xs={12} className={cx(s.landingContent, s.spaceTop5)}>
