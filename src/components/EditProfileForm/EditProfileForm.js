...
class EditProfileForm extends Component {
  ...
  render() {
    ...
    return (
      <div className={cx('inputFocusColor', 'editProfileRTL')}>
        ...
        <Panel className={s.panelHeader} header={title}>
          <Form onSubmit={handleSubmit(submit)}>
            <Row className={s.formGroup}>
              <Col componentClass={ControlLabel} xs={12} sm={3} md={3} lg={3} className={cx(s.textAlign, 'textAlignLeftRTL')}>
            ...
            <Row className={cx(s.formGroup)} >
              <Col xs={12} sm={3} md={3} lg={3} className={cx(s.textAlign, 'textAlignLeftRTL')}>
            ...
            <Row className={s.formGroup}>
              ...
              <Col componentClass={ControlLabel} xs={12} sm={9} md={9} lg={9}>
                <Field name="info"
                  ...
                  className={cx(s.formControlInput, s.commonBorder, s.textAreaBorder)}
                />
              </Col>
            </Row>
            ...
            <Row className={s.formGroup}>
              <Col xs={12} sm={12} md={12} lg={12} className={s.spaceTop3}>
                <Button bsSize="small" className={cx(s.button, s.btnPrimary, s.btnlarge, 'floatLeftRTL')} type="submit" disabled={submitting}
                >
