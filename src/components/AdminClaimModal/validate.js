...
export default function validate(values) {
    ...
    if (isNaN(values.claimRefund) || (!/^[0-9\.]+$/.test(values.claimRefund)) || (parseFloat(values.claimRefund, 10) != 0 && parseFloat(values.claimRefund, 10) < 1)) {
        errors.claimRefund = messages.claimRefundInvalid;
    }
