                                        ...
                                        <Col xs={12} sm={6} md={6} lg={6} className={s.noPadding}>
                                            ...
                                            <Col xs={12} sm={12} md={12} lg={12}>
                                                <Field name="name"
                                                    ...
                                                    className={cx(s.formControlInput, s.backgroundTwo, s.commonBorder, 'contactInputRTL')}
                                                />
                                            </Col>
                                        </Col>
                                        <Col xs={12} sm={6} md={6} lg={6} className={s.noPadding}>
                                            ...
                                            <Col xs={12} sm={12} md={12} lg={12}>
                                                <Field name="phoneNumber"
                                                    ...
                                                    className={cx(s.formControlInput, s.backgroundThree, s.commonBorder, 'contactInputRTL')}
                                                />
                                            </Col>
                                        </Col>
                                    </Row>
                                    <Row className={s.formGroup}>
                                        ...
                                        <Col xs={12} sm={12} md={12} lg={12}>
                                            <Field name="email"
                                                ...
                                                className={cx(s.formControlInput, s.backgroundOne, s.commonBorder, 'contactInputRTL')}
                                            />
                                        </Col>
                                    </Row>
                                    <Row className={s.formGroup}>
                                        ...
                                        <Col xs={12} sm={12} md={12} lg={12}>
                                            <Field name="ContactMessage"
                                                ...
                                                className={cx(s.formControlInput, s.backgroundFour, s.commonBorder, s.textAreaBorder, 'contactTextInputRTL')}
                                            />
                                        </Col>
                                    </Row>
