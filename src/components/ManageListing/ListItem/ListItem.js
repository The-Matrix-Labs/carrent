          ...
          <Row>
            <Col xs={12} xsOffset={0} smOffset={1} sm={10} mdOffset={1} md={10} lgOffset={1} lg={10}>
              ...
              <Col xs={12} sm={12} md={12} lg={12} className={s.noPadding}>
                <Button
                  className={cx(s.button, s.btnPrimary, s.btnlarge, s.spaceTop4, s.spaceRight2, s.smButton, 'spaceRight2RTL')}
        ...
        <li className={s.panelBody} >
          <Row>
            <Col xs={12} sm={12} className={cx('hidden-md hidden-lg', s.space2)}>
              <a href="javascript:void(0);" onClick={this.openRemoveList} className='manageCloseIconRTL'>
                <FontAwesome.FaClose className={cx(s.iconRemove, s.icon, 'pull-right', 'iconRemoveRTL')} />
              </a>
            </Col>
            ...
            <Col xs={12} sm={12} md={7} lg={7} className={s.listDetailContent}>
              ...
              <Col xs={12} sm={12} md={12} lg={12} className={s.noPadding}>
                <Button className={cx(s.button, s.btnPrimary, s.spaceRight2, s.spaceTop3, s.smButton, s.marginRight3, s.fontSize13, 'spaceRight2RTL')} onClick={() => this.handleEditListing(listId)}>
                  {
                ...
                </Button>
                {
                  data && data.listingSteps && data.isReady && <a
                    ...
                    target="_blank"
                    className={cx('btn btn-default', s.button, s.btnPrimaryBorder, s.spaceTop3, s.smButton, s.fontSize13)}
                  >
