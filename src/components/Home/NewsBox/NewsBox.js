              ...
              <Row>
                <Col lg={6} md={6} sm={6} xs={12}>
                  <div className={cx(s.tableCell, s.imageColumn)}>
                    <img src={"/images/banner/x_" + image} className={cx('img-responsive', s.imgShadow, 'imgShadowRTL')} />
                  </div>
                </Col>
                <Col lg={6} md={6} sm={6} xs={12}>
                  <div className={cx(s.tableCell, s.textColumn, s.desktopView, 'textColumnRTL')}>
                    ...
                    <Link to={"/why-become-owner"} className={cx(s.btn, s.btnPrimary)}>{buttonLabel}</Link>
                  </div>
                </Col>
              </Row>
