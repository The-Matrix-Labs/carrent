    ...
    renderFormControl = ({ input, label, type, meta: { touched, error }, className, placeholder }) => {
        ...
        return (
            <FormGroup className={cx(s.formGroup, 'row')}>
                <Col xs={12} sm={12} md={12} lg={12} className={s.customPadding}>
    ...
    render() {
        ...
        return (
            ...
            <form onSubmit={handleSubmit(this.submitForm)} autoComplete="off" className={s.formContainer}>
                {
                    shown && <a className={cx(s.modalCaptionLink, s.labelText, s.noMargin, s.paddingRight)} onClick={this.toggle}>
                ...
                }
                {
                    !shown && <div>
                        ...
                        <FormGroup className={cx(s.spaceTop3, s.formGroup)}>
                            ...
                            <Button className={cx(s.button, s.btnPrimaryBorder, s.marginLeft, 'createBtnRTL')}
                                disabled={submitting}
                                onClick={this.toggle}>
