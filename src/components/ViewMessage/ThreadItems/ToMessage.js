...
class ToMessage extends Component {
  ...
  render() {
    ...
    return (
      <div>
        <div>
          <div className={cx(s.space5, s.tripRadius, s.tripRadiusPadding, s.tripBorderColor)}>
            <div className={s.displayTable}>
              <div className={s.displayTableRow}>
                <div className={cx(s.displayTableCell, s.displayTableWidth, s.radiusColor)}>
                  <Panel className={cx(s.panelDark, s.panelBubble, s.panelText, s.panelBubbleRight, s.tripRadius)}>
                    <span>{content}</span>
                    <div className={cx(s.timeText, s.spaceTop1)}>
                      <span>{date}</span>
                    </div>
                  </Panel>
                </div>
