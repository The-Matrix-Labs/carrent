...
class ContactHost extends React.Component {
  ...
  render() {
    ...
    let isSameTime = (startTime >= endTime) || false;
                    ...
                    <Col md={8} className={s.noPadding}>
                      ...
                      >
                        <Panel className={cx(s.guestModal, 'guestpanel')}>
                          ...
                          {
                            isDateChosen && maximumStay && this.renderWarningBlock(<p><FormattedMessage {...messages.maximumStay} /> {maxDay} <FormattedMessage {...messages.nights} /></p>, "error")
                          }
                          {
                          ...
                          }
                          {
                            ...
                            this.renderWarningBlock(<FormattedMessage {...messages.chooseDifferentEndTime} />)
                          }
                            ...
                            <div className={s.space4}>
                              <Row>
                                <Form onSubmit={handleSubmit(submit)}>
                                  <Col lg={12} md={12} sm={9} xs={12} className={s.marginBottom15}>
                                  ...
                                  <FormGroup className={s.formGroup}>
                                    <Row className={s.noMargin}>
                                      ...
                                      <Col xs={12} sm={6} md={6} lg={6} className={s.responsiveMarginBottom}>
                                        <TimeField
                                          name={"startTime"}
