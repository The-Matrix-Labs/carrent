  ...
  render() {
    ...
    return (
      <Panel
        ...
        header={
          <ul className={cx('list-inline', s.noMargin, 'listContainerRTLMb')}>
        ...
        <Row>
          <Col xs={12} sm={12} md={12} lg={12} className='transactionSelectRTL'>
            {
            ...
            {
              !loading && getTransactionHistory && getTransactionHistory.count > 0 && <div className={cx(s.csvExport, 'floatLeftRTL')}>
