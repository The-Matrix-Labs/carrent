    ...
    render() {
        ...
        return (
            <div className={cx(s.pagecontentWrapper, 'pagecontentWrapperRTL')}>
                <div>
                    <h1 className={s.headerTitle}><FormattedMessage {...messages.reportUser} /></h1>
                                        ...
                                        <Tr key={index}>
                                            ...
                                            }
                                            {
                                                ...
                                                <Td data-label={formatMessage(messages.reporterEmail)} column={formatMessage(messages.reporterEmail)}>
                                                    <a href={"/users/show/" + value.userProfileId.profileId} target="_blank">
                                            ...
                                            }
                                            {
                                                ...
                                                <Td data-label={formatMessage(messages.userEmailLabel)} column={formatMessage(messages.userEmailLabel)}>
                                                    <a href={"/users/show/" + value.userData.profileId} target="_blank">
                                            ...
                                            {
                                                value.reportType &&
                                                <Td data-label={formatMessage(messages.reportType)}
                                            ...
                                            {
                                                value && <Td data-label={formatMessage(messages.dateLabel)} column={formatMessage(messages.dateLabel)}>
                                                    {date}
                                                </Td>
                                            }
                                        </Tr>
