          ...
          <div>
            ...
            <Col xs={12} sm={12} md={8} lg={7} className={s.blockcenter}>
              <div className={cx(s.space4, cp.textAlignRight, 'textAlignLeftRTL')}>
                <Link to={"/siteadmin/staticpage/management"} className={cx(cp.btnPrimaryBorder, cp.btnlarge)}>
              ...
              <div className={s.panelHeader}>
                <form onSubmit={handleSubmit(submit)}>
                  ...
                  <Field name="metaDescription" component={this.renderFormControlTextArea} label={formatMessage(messages.metaDescriptionLabel)} />
                  <FormGroup className={s.space3}>
                    <Row>
                      <Col xs={12} sm={12} md={12} lg={12}>
