    ...
    render() {
        ...
        return (
            <div className={cx(s.pagecontentWrapper, 'pagecontentWrapperRTL')}>
                <ModalForm />
                <div>
                    <h1 className={s.headerTitle}><FormattedMessage {...(type === 'reservation' || type === 'security-deposit' ? messages.viewReservationHeading : messages.payoutLabel)} /></h1>
                    <div className={cx(cp.textAlignRight, s.space4, 'textAlignLeftRTL')}>
                        <Link to={url} className={cx(cp.btnPrimaryBorder, cp.btnlarge)}>
                    ...
                    <div className={s.profileViewMain}>
                        {
                            data && data.id && <div className={s.profileViewInner}>
                                <span className={cx(cp.labelTextNew, s.profileViewlabel)}><FormattedMessage {...messages.reservationId} /></span>
                                <span className={cx(s.profileViewMainContent)}> {data.id}</span>
                            </div>
                        }
                        {
                            data && data.confirmationCode && <div className={s.profileViewInner}>
                                <span className={cx(cp.labelTextNew, s.profileViewlabel)}><FormattedMessage {...messages.confirmationCode} /></span>
                                <span className={cx(s.profileViewMainContent)}> {data.confirmationCode}</span>
                            </div>
                        }
                        {
                            reservationStatus && <div className={s.profileViewInner}>
                                <span className={cx(cp.labelTextNew, s.profileViewlabel)}><FormattedMessage {...messages.reservationStatus} />  </span>
                        ...
                        }
                        {
                            data && data.cancellationDetails && data.cancellationDetails.cancellationPolicy && <div className={s.profileViewInner}>
                                <span className={cx(cp.labelTextNew, s.profileViewlabel)}><FormattedMessage {...messages.chooseCancellationPolicy} /></span>
                        ...
                        }
                        {
                            data && data.cancellationDetails && data.cancellationDetails.cancelledBy && <div className={s.profileViewInner}>
                                <span className={cx(cp.labelTextNew, s.profileViewlabel)}><FormattedMessage {...messages.cancelledLabel} /></span>
                        ...
                        }
                        {
                            data && data.listData && data.listData.id && data.listData.title && <div className={s.profileViewInner}>
                                <span className={cx(cp.labelTextNew, s.profileViewlabel)}><FormattedMessage {...messages.carNameLabel} /></span>
                                <span className={cx(s.profileViewMainContent)}><a href={"/cars/" + data.listData.id} target="_blank"> {data.listData.title}</a></span>
                            </div>
                        }

                        {
                            data && data.checkIn && <div className={s.profileViewInner}>
                                <span className={cx(cp.labelTextNew, s.profileViewlabel)}><FormattedMessage {...messages.checkIn} /></span>
                        ...
                        }
                        {
                            data && data.checkOut && <div className={s.profileViewInner}>
                                <span className={cx(cp.labelTextNew, s.profileViewlabel)}><FormattedMessage {...messages.checkOut} />   </span>
                        ...
                        }
                        {
                            bookingType && <div className={s.profileViewInner}>
                                <span className={cx(cp.labelTextNew, s.profileViewlabel)}><FormattedMessage {...messages.bookingType} /></span>
...

                        {
                            data && data.delivery != 0 && (subTotal == 0 || subTotal > 0) && <div className={s.profileViewInner}>
                                <span className={cx(cp.labelTextNew, s.profileViewlabel)}><FormattedMessage {...messages.deliveryFeeLabel} /></span>
                        ...
                        }
                        {
                            data && (amountPaid == 0 || amountPaid > 0) && <div className={s.profileViewInner}>
                                <span className={cx(cp.labelTextNew, s.profileViewlabel)}><FormattedMessage {...messages.amountPaid} /></span>
                        ...
                        <div className={s.profileViewInner}>
                            <span className={cx(cp.labelTextNew, s.profileViewlabel)}><FormattedMessage {...messages.renterServiceFee} /></span>
                        ...
                        </div>
                        {
                            data && <div className={s.profileViewInner}>
                                <span className={cx(cp.labelTextNew, s.profileViewlabel)}><FormattedMessage {...messages.carOwnerServiceFee} /></span>
                        ...
                        }
                        {
                            data && data.guestData && data.guestData.profileId && Guestname && <div className={s.profileViewInner}>
                                <span className={cx(cp.labelTextNew, s.profileViewlabel)}><FormattedMessage {...messages.renterName} /></span>
                        ...
                        }
                        {
                            data && data.guestData && data.guestData.phoneNumber && <div className={s.profileViewInner}>
                                <span className={cx(cp.labelTextNew, s.profileViewlabel)}><FormattedMessage {...messages.renterPhoneNumber} /></span>
                        ...
                        }
                        {
                            data && data.guestUser && data.guestUser.email && <div className={s.profileViewInner}>
                                <span className={cx(cp.labelTextNew, s.profileViewlabel)}><FormattedMessage {...messages.renterEmail} /></span>
                        ...
                        }
                        {
                            data && data.hostData && data.hostData.profileId && Hostname && <div className={s.profileViewInner}>
                                <span className={cx(cp.labelTextNew, s.profileViewlabel)}><FormattedMessage {...messages.carOwnerName} /></span>
                        ...
                        }
                        {
                            data && data.hostData && data.hostData.phoneNumber && <div className={s.profileViewInner}>
                                <span className={cx(cp.labelTextNew, s.profileViewlabel)}><FormattedMessage {...messages.carOwnerPhoneNumber} /></span>
                        ...
                        }
                        {
                            data && data.hostUser && data.hostUser.email && <div className={s.profileViewInner}>
                                <span className={cx(cp.labelTextNew, s.profileViewlabel)}><FormattedMessage {...messages.carOwnerEmail} /></span>
                        ...
                        }
                        {
                            data && data.cancellationDetails && data.cancellationDetails.createdAt && <div className={s.profileViewInner}>
                                <span className={cx(cp.labelTextNew, s.profileViewlabel)}><FormattedMessage {...messages.cancelDate} /></span>
                        ...
                        }
                        {
                            data && cancellationDetails && (cancellationDetails.refundToGuest == 0 || cancellationDetails.refundToGuest > 0) && <div className={s.profileViewInner}>
                                <span className={cx(cp.labelTextNew, s.profileViewlabel)}><FormattedMessage {...messages.refundAmount} /></span>
                        ...
                        }
                        {
                            data && (data.reservationState == 'approved' || data.reservationState == 'completed' || data.reservationState == 'cancelled') && <div className={s.profileViewInner}>
                                <span className={cx(cp.labelTextNew, s.profileViewlabel)}><FormattedMessage {...messages.payoutLabel} /></span>
                        ...
                        }
                        {
                            data && data.securityDeposit > 0 && <div className={s.profileViewInner}>
                                <span className={cx(cp.labelTextNew, s.profileViewlabel)}><FormattedMessage {...messages.securityDeposit} /></span>
                        ...
                        }
                        {
                            data && data.claimPayout > 0 && <div className={s.profileViewInner}>
                                <span className={cx(cp.labelTextNew, s.profileViewlabel)}><FormattedMessage {...messages.securityDepositToHost} /></span>
                        ...
                        }
                        {
                            data && data.claimRefund > 0 && <div className={s.profileViewInner}>
                                <span className={cx(cp.labelTextNew, s.profileViewlabel)}><FormattedMessage {...messages.securityDepositToGuest} /></span>
...
export default withStyles(s, cp)(connect(mapState, mapDispatch)(ViewReservation));