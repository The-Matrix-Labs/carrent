...
class Accounts extends Component {
    ...
    render () {
        ...
        if(items !== null){
            ...
            return (
                <ul className={cx(s.listStyle, s.space3, 'listContainerRTL')}>
                    {
                    ...
                    {/* {
                      ...
                      {
                        !items.isEmailConfirmed && !items.isGoogleConnected && !items.isIdVerification && <NoItem isLoggedInUser={isLoggedInUser} />
                    }
                    {
                        isLoggedInUser && count > 0 && count < 3 &&  <li className={s.space2}>
