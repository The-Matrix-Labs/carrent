      ...
      <div className={s.root}>
        ...
        <div className={s.container}>
          <Navbar fluid className={cx(s.rentAllHeader, 'ListHeader')} fixedTop={true} expanded={false}>
            <Navbar.Header>
              <Navbar.Brand className={cx('hidden-xs', s.breakPoint, 'listHeaderLogo', 'listHeaderLogoRTL')} >
                <Logo link={"/"} className={cx(s.brand, s.brandImg)} />
              </Navbar.Brand>
              <Navbar.Toggle className={cx(s.brandBorder, s.navBarToggle, s.navBarToggleList, 'navBarToggleListRTL')} children={
