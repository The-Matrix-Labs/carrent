                  ...
                  if(item.listsettings.isEnable === "1"){
                    return (
                      <div className={s.houseRules} key={index}>
                        <span className={cx(s.displayInline, s.houseRuleContentSection)}>{item.listsettings.itemName}</span>
                        <span className={cx(s.displayInline, s.houseRuleImage)}><FontAwesome.FaCheckCircle className={s.circleIcon} /></span>
                      </div>
                    )
                  }
                })
