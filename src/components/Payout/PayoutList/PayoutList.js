                  ...
                  <tbody>
                    {
                      data.length > 0 && data.map((item, index) => {
                        ...
                        return (
                            ...
                            <td>{item.paymentMethod.name} {checkDefault && item.default && <Label bsStyle="success"><FormattedMessage {...messages.default} /></Label>}</td>
                              <td>
                                {
                                ...
                                }
                                {
                                  ...
                                  >
                                    ...
                                    <OverlayTrigger
                                      ...
                                      placement="top"
                                    >
                                      <span>&nbsp;<FaInfoCircle style={{color: COMMON_TEXT_COLOR}} /></span>
                                    </OverlayTrigger>
                                  </a>
                                }
                                {
                                  !item.default && <a
                                    className={cx(s.textSpace, 'textSpaceRTL', { [s.transparentText]: payoutRemoveLoader })}
                                    href="javascript:void(0)" 
                                    onClick={() => {
