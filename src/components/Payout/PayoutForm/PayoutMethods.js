      ...
      <div className={cx('inputFocusColor', 'commonListingBg')}>
        <form onSubmit={handleSubmit}>
          <Panel
            ...
            footer={
              <div>
                <Button className={cx(s.button, bt.btnLarge, bt.btnPrimaryBorder, s.btnRight, 'payoutBackRTL')} onClick={previousPage}>
                  <FormattedMessage {...messages.back} />
                </Button>
                <Button className={cx(s.button, bt.btnPrimary, bt.btnLarge)} disabled={loading} type="submit">
