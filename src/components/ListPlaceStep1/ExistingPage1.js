...
import defaultPic from './vector.jpg';
              ...
              <div>
                <div className={cx(s.displayTable, s.positionRelative)}>
                  <div className={s.displayTableRow}>
                    ...
                    <div
                      className={cx(s.circle, 'circleSuccessRTL', { [s.circleSuccess]: stepOneCircle })}
                    >
                    </div>
                    <div className={cx(s.positionRelative)}>
                      <div className={cx(s.displayTableCell, s.vtrTop, s.contentWidth, s.paddingBottom, s.paddingLeft, s.mainSection)}>
                        <div className={s.contentSection}>
                          ...
                          <h3 className={s.landingContentTitle}><FormattedMessage {...messages.step1SubHeading} /></h3>
                          ...
                          {
                            step1 == "completed" && <a href="javascript:void(0);" className={s.modalCaptionLink} onClick={() => nextPage('car')}>
              ...
              <div>
                <div className={cx(s.displayTable, s.positionRelative)}>
                  <div className={s.displayTableRow}>
                    ...
                    <div
                      className={cx(s.circle, 'circleSuccessRTL', { [s.circleSuccess]: stepTwoCircle })}
                    >
                    </div>
                    <div className={cx(s.positionRelative)}>
                      <div className={cx(s.displayTableCell, s.vtrTop, s.contentWidth, s.paddingBottom, s.paddingLeft, s.mainSection)}>
              ...
              <div>
                <div className={cx(s.displayTable, s.positionRelative)}>
                  <div className={s.displayTableRow}>
                    ...
                    <div
                      className={cx(s.circle, 'circleSuccessRTL', { [s.circleSuccess]: stepThreeCircle })}
                    >
                    </div>
                    <div className={cx(s.positionRelative)}>
                      <div className={cx(s.displayTableCell, s.vtrTop, s.contentWidth, s.paddingLeft, s.mainSection)}>
                        <div className={s.contentSection}>
                          ...
                          {
                            step3 == "active" && <Button className={cx(s.button, s.btnPrimary)} onClick={() => nextPage('renter-requirements')}>
                              <FormattedMessage {...messages.continue} />
                            </Button>
                          }
                          {
                            step3 == "completed" && <a href="javascript:void(0);" className={s.modalCaptionLink} onClick={() => nextPage('renter-requirements')}>
                              <FormattedMessage {...messages.change} />
                            </a>
                          }
                        </div>
              ...
              </Col>
              {
                listingSteps && isReady && !isPublished && !userBanStatusValue && isShowButton && <Col xs={12} sm={12} md={12} lg={12} >
                  ...
                  <Col xs={12} sm={12} md={12} lg={12} className={cx(s.spaceTop3, s.noPadding)}>
                    ...
                    <a target="_blank" href={"/cars/" + id + "/preview"} className={cx(s.previewLink, 'previewLinkRTL')}>
              ...
              }
              {
                listingSteps && isReady && isPublished && !userBanStatusValue && isShowButton && <Col xs={12} sm={12} md={12} lg={12} >
                  ...
                  <Col xs={12} sm={12} md={12} lg={12} className={cx(s.spaceTop3, s.noPadding)}>
                    ...
                    <a target="_blank" href={"/cars/" + id + "/preview"} className={cx(s.previewLink, 'previewLinkRTL')}><FormattedMessage {...messages.previewListing} /> </a>
                  </Col>
                </Col>
              }
              {
                userBanStatusValue == true && isShowButton && <Col xs={12} sm={12} md={12} lg={12} >
                  <Col xs={12} sm={12} md={12} lg={12} className={cx(s.spaceTop3, s.noPadding)}>
                    <a target="_blank" href={"/cars/" + id + "/preview"} className={cx(s.previewLinkUserBan)}>
                      <FormattedMessage {...messages.previewListing} />
                    </a>
                  </Col>
                </Col>
