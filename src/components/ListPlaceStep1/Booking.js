                ...
                <label className={s.displayTable}>
                  <span className={s.displayTableRow}>
                    ...
                    <span className={s.displayTableCell}>
                      <span className={cx(s.bookText, 'bookTextRTL')}><FormattedMessage {...messages.whoCanBookInfo1} /></span>
              ...
              <div className={cx(s.space6, s.spaceTop3)}>
                <label className={s.displayTable}>
                  <span className={s.displayTableRow}>
                    ...
                    <span className={s.displayTableCell}>
                      <span className={cx(s.bookText, s.marginLeft5, 'bookTextRTL')}><FormattedMessage {...messages.whoCanBookInfo3} /></span>
                    </span>
                  </span>
                </label>
              </div>
                ...
                <div className={s.nextBackButton}>
                  ...
                  <FormGroup className={s.formGroup}>
                    <Col xs={12} sm={12} md={12} lg={12} className={s.noPadding}>
                      <Button className={cx(s.button, s.btnPrimaryBorder, s.btnlarge, s.pullLeft, 'floatRightRTL')} onClick={() => previousPage("discount")}>
                        <FormattedMessage {...messages.back} />
                      </Button>
                      <Button className={cx(s.button, s.btnPrimary, s.btnlarge, s.pullRight, 'floatLeftRTL')} onClick={() => nextPage("local-laws")}>
