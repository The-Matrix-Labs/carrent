...
class Page8 extends Component {
  ...
  render() {
    ...
    const { spaces, isDisabled, carFeatures } = this.state;
                  ...
                  <div className={s.nextBackButton}>
                    ...
                    <FormGroup className={s.formGroup}>
                      <Col xs={12} sm={12} md={12} lg={12} className={s.noPadding}>
                        ...
                        <Button className={cx(s.button, s.btnPrimary, s.btnlarge, s.pullRight, 'floatLeftRTL')} disabled={isDisabled} type="submit">
