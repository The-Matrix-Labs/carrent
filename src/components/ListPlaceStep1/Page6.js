...
class Page6 extends Component {
  ...
  render() {
    ...
    return (
      <Grid fluid>
        <Row className={cx(s.landingContainer, 'locationRTL')}>
                  ...
                  <div className={s.nextBackButtonMap}>
                    ...
                    <FormGroup className={s.formGroup}>
                      <Col xs={12} sm={12} md={12} lg={12} className={s.noPadding}>
                        <Button className={cx(s.button, s.btnPrimaryBorder, s.btnlarge, s.pullLeft, 'floatRightRTL')} onClick={() => previousPage("location")}>
                          <FormattedMessage {...messages.back} />
                        </Button>
                        <Button className={cx(s.button, s.btnPrimary, s.btnlarge, s.pullRight, 'floatLeftRTL')} onClick={() => nextPage("features")} disabled={isDisabled}>
